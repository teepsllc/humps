...
describe('humps', function() {
  ...
  beforeEach(function() {
    ...
    this.uncopyableSection = {
      uncopyable: true
    };

    this.withUncopyableSubObject = {
      'attr-one': this.uncopyableSection
    };

    this.uncopyableTester = function(obj) {
      return obj.uncopyable;
    };
  });
  ...
  describe('.camelizeKeys', function() {
    ...
    it('avoids touching uncopyable objects', function() {
      actual = humps.camelizeKeys(this.withUncopyableSubObject, { uncopyableTester: this.uncopyableTester });
      assert.equal(actual.attrOne, this.uncopyableSection);
    })
  });
